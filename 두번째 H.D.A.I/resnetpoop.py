...
class ResNet1d(nn.Module):
    def __init__(self, block, layers, input_channels=8, inplanes=32, num_classes=1):
        ...
        self.layer1 = self._make_layer(BasicBlock1d, 32, layers[0])
        self.layer2 = self._make_layer(BasicBlock1d, 16, layers[1], stride=2)
        self.adaptiveavgpool = nn.AdaptiveAvgPool1d(1)
        self.adaptivemaxpool = nn.AdaptiveMaxPool1d(1)
        self.fc1 = nn.Linear(16 * block.expansion * 2, num_classes)
...
def resnet18(**kwargs):
    model = ResNet1d(BasicBlock1d, [3, 4], **kwargs)
    return model