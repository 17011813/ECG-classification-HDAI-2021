...
class ResNet1d(nn.Module):
    def __init__(self, block, layers, input_channels=8, inplanes=64, num_classes=2):
        ...
        self.fc1 = nn.Linear(512 * block.expansion * 2, 256)
    ...
    def forward(self, x):
        ...
        #x = x.argmax(axis=-1).type(torch.FloatTensor)
